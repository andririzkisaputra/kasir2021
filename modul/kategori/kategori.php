...
switch($act) {
	default :?>
    <form method="post" action="<?php echo $set->folder_modul.'/'.$modul;?>/aksi.php?<?php echo $set->folder_modul.'='.$modul.'&act=new';?>" name="form" id="form">
    <fieldset class="atas">
<table>
		<tr>
		<th>Create New</th>
...
?>
<form method="post" action="<?php echo $set->folder_modul.'/'.$modul;?>/aksi.php?<?php echo $set->folder_modul.'='.$modul;?>&id=<?php echo $id;?>" name="form" id="form">
<fieldset class="atas">
<table>
		<tr>
...
$q = yposSQL('SHOW','ypos_kategori','idkat, nama_kat',"ids=$_SESSION[yids]",'nama_kat');
                ...
                <td align="center"><?php echo $no;?></td>
					...
					<td align="center">
					<a href="<?php echo $set->folder_modul.'='.$modul?>&act=edit&id=<?php echo $r['idkat'];?>">Edit</a>
					</td>
				</tr>
                <?php
				$no++;
