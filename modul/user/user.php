...
<table>
		<tr>
			...
			<td><input type="text" class="inp-form" name="nm" required="required" placeholder="Nama Lengkap" size="40" value="<?php echo $ed['nama_lengkap'];?>"/></td>
            <td><input type="text" class="inp-form" name="hp" required="required" placeholder="No HP" size="20" value="<?php echo $ed['hp'];?>"/></td>
		</tr>
                <tr>
		<th>Password</th>
        <td><input type="text" class="inp-form" name="pass" placeholder="Password"/></td>
