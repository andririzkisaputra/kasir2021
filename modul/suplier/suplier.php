...
while ($r = $q->fetch_array()) {?>
                ...
                <td align="center"><?php echo $no;?></td>
					...
					<td align="center">
					<a href="<?php echo $set->folder_modul.'='.$modul?>&act=edit&id=<?php echo $r['kdsup'];?>">Edit</a> - <a href="<?php echo $set->folder_modul.'='.$modul?>&act=delete&id=<?php echo $r['kdsup'];?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')">Delete</a>
					</td>
				</tr>
                <?php
				$no++;
