...
echo '<table id="dataTable"  class="table" width="100%">
	...
	echo "<tr align=center>			
				...
				<a href='$set->folder_modul=$modul&act=edit&id=$r[kdbarang]'>Edit</a> - <a href='$set->folder_modul=$modul&act=delete&id=$r[kdbarang]' onClick=return confirm('Anda yakin ingin menghapus data ini?')>Delete</a></td>
				</tr>";
				$no++;
				} // end while
echo '</table>';
